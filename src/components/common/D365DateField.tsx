    ...
    <div className="mb-3 text-right">
      ...
      <div className="relative">
        <input
          ...
          min={min}
          max={max}
          className="w-full h-8 px-2.5 bg-white text-[#323130] text-xs border border-[#8A8886] focus:border-[#0078D4] focus:ring-1 focus:ring-[#0078D4] outline-none disabled:bg-[#F3F2F1] disabled:cursor-not-allowed transition-colors font-mono"
        />
      </div>
